...
void show_all(struct node1 *month, struct node2 *border, struct node3 *expences, struct node4 *daily, int total_day, int total_border, int expd_type);
...
if(strcmp(st,"help")==0)           help(); 
    ...
    {  
       ...
       daily= entry_node4(daily, month, total_day);  
       ...
       if(flag==1)     
        show_all(month, border, expences, daily, total_day, total_border, expd_type);
...
void Calculation(struct node1 *month, struct node2 *border, struct node3 *expences, struct node4 *daily, struct node5 *elect, int total_day, int total_border, int expd_type)
{
    ...
    { 
        ...
        {    
            ...
            if(ch=='y' || ch=='Y') 
            {    
                if(strcmp(expences->name,"elect")==0||strcmp(expences->name,"electric")==0||strcmp(expences->name,"Elect")==0||strcmp(expences->name,"ELECT")==0)
                {
...
struct node1 *entry_node1(struct node1 *month)
{
    ...
    cout<<"enter month name(all small letter):\t"; cin>>month->month_name;    
